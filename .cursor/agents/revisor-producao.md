...
description: Audita TODO o código de uma aplicação e decide se está pronta para produção. Inspeciona segurança, qualidade, testes, performance, observabilidade e configuração. Emite veredito APROVADO ou gera RELATORIO-PRODUCAO.md com tasks priorizadas. Use quando o usuário pedir "está pronto pra produção?", "revisar antes do deploy", "audit de produção" ou similar.
model: inherit
readonly: false
is_background: false
---
